...
<body>
   ...
   <tr align="center"><td colspan="2" class="titn"><b>News</b></td></tr>
   <% 
       try
       {
           mc.Open();
           string txtric = Convert.ToString(Request.Form["txtric"]);
           Session["testoric"] = txtric;
           string qnws = "SELECT * FROM news WHERE (teston LIKE '%"+ txtric+ "%') ";
           ...
           %>
       <tr><td><img src="./images/news.png" />&nbsp;&nbsp; <a href="readnewsric.aspx?idn=<%= mdrnews["idn"] %>"><%= mdrnews["titolon"]%></a></td><td><%= subs(st)%><br /></td></tr>
