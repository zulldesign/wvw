...
<body>
   <!-- #include virtual="../config.inc -->
    <%  
        ...
        string q = "INSERT INTO news(categoria, autore, titolon, anno, mese, datan, teston, msgemail) ";
        q += "VALUES (?cat, ?aut, ?tit, ?ann, ?mon, ?dat, ?txt, ?mem)";
        MySqlCommand mcomm = new MySqlCommand(q, mc);

        mcomm.Parameters.AddWithValue("?cat", cat);
        mcomm.Parameters.AddWithValue("?aut", aut);
        mcomm.Parameters.AddWithValue("?tit", tit);
        mcomm.Parameters.AddWithValue("?ann", ann);
        mcomm.Parameters.AddWithValue("?mon", mon);   
        mcomm.Parameters.AddWithValue("?dat", dat);
        mcomm.Parameters.AddWithValue("?txt", txt);
        mcomm.Parameters.AddWithValue("?mem", mem);    
