...
<%
	...
	SQLLinkLog = " DELETE * FROM [LinkLog] WHERE [ID] = "& cInt(FID) &""
						...
						<table border="0" width="700" cellspacing="0" cellpadding="0">
							<tr>
								<td width="550" valign="top" style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px">
									<p align="justify">
										\\ <b><a href="default.asp"><%=Testo_Path_Pannello%></a> : <a href="linklog_elenco.asp"><%=Testo_Sezione_LinkLog%></a> : <%=Testo_Modulo_PulsanteCancella%></b>
									</p>
									<p align="justify">
										<%=Testo_LinkLog_CancellazioneABuonFine%>, <a href="<%=Request.ServerVariables("HTTP_REFERER")%>"><%=Testo_LinkLog_LinkTornaIndietro%></a>.
									</p>
								</td>
