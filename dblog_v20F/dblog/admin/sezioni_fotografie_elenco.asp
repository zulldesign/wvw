						...
						<table border="0" width="320" cellspacing="0" cellpadding="0">
							<tr>
								<td width="320" valign="top" style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px">
									...
									<p align="justify">
										<%=Testo_Fotografie_IntroduzioneSezioniDisponibili%>
									</p>
...
%>
										<tr>
											...
											<td valign="top" align="right">
												<a href="sezioni_fotografie_modifica.asp?s=<%=Server.URLEncode(RSSezioni("Sezione"))%>"><%=Testo_Sezioni_LinkRinomina%></a>
											</td>
										</tr>
<%
			RSSezioni.MoveNext
