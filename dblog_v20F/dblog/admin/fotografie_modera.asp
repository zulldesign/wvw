						...
						<table border="0" width="700" cellspacing="0" cellpadding="0">
							<tr>
								<td width="550" valign="top" style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px">
									<p align="justify">
										\\ <b><a href="default.asp"><%=Testo_Path_Pannello%></a> : <a href="fotografie_elenco.asp"><%=Testo_Sezione_Fotografie%></a> : <%=Testo_Sezione_ModeraCommenti%></b>
									</p>
...
<%
	...
	SQLCommenti = " SELECT * FROM [Commenti] WHERE Commenti.IDFotografia = "& cInt(FID) &" AND Commenti.IDFotografia <> 0 "
										...
										<tr>
											<td width="450" bgcolor="#FBFBFB" style="PADDING-RIGHT: 7px; PADDING-LEFT: 7px; PADDING-BOTTOM: 7px; PADDING-TOP: 7px">
												<p align="justify">
													...
													<br><b><%=Testo_TabellaCommenti_RigaInviato%></b> <%=StrToData(RSCommenti("Data"))%> @ <%=StrToOra(RSCommenti("Ora"))%>&nbsp;<%=Testo_TabellaCommenti_RigaInviatoIndirizzoIP%>&nbsp;<%=RSCommenti("IP")%>
...
<%
		For Temp = 1 To RSCommenti.PageCount
			Response.Write "<a href=""fotografie_modera.asp?id="& Server.HTMLEncode(FID) &"&s="& Server.HtmlEncode(Request.QueryString("s")) &"&a="& Server.HtmlEncode(Request.QueryString("a")) &"&pagina=" & Temp & """>"
			Response.Write Temp
			Response.Write "</a> "
		Next
%>
...
%>
										<tr>
											<td width="450" bgcolor="#FBFBFB" style="PADDING-RIGHT: 7px; PADDING-LEFT: 7px; PADDING-BOTTOM: 7px; PADDING-TOP: 7px">
												<%=Testo_TabellaCommenti_ErroreNessunCommentoTrovato%>, <a href="fotografie_elenco.asp"><%=Testo_LinkTornaElenco%></a>.
											</td>
										</tr>
<%
	End If
