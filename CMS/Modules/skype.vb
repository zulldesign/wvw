...
Namespace WebApplication
	Public Module Skype
        ...
        If Not (Char.IsLetterOrDigit(Chr) OrElse Chr = "."c OrElse Chr = "_"c OrElse Chr = ","c OrElse Chr = "@"c OrElse Chr = "-"c) Then
          Return False
        End If
			Next
			Return True
      ...
      For Each Chr As Char In SkypeUserName.ToCharArray
        ...
        Else
          ImgOnlineSkypeUser &= "-" & Extension.Right("00" & Hex(Asc(Chr)), 2)
        End If
      Next
		End Function

		Public Function SkypeUrl(ByVal SkypeUserName As String) As String
      If Not String.IsNullOrEmpty(SkypeUserName) Then
        If SkypeUserName.First = "+"c Then
