...
Namespace WebApplication
	Public Module Tables
      ...
      Public Name As String
		...
		Private Function LoadCities() As Collections.Generic.Dictionary(Of String, Collections.Generic.List(Of City))
          ...
          City.CountryID = CInt(Fields(1))
          City.RegionID = CInt(Fields(2))
          City.Name = StringValue(Fields(3))
          City.Latitude = Convert.ToSingle(StringValue(Fields(4)), Globalization.CultureInfo.InvariantCulture)
          City.Longitude = Convert.ToSingle(StringValue(Fields(5)), Globalization.CultureInfo.InvariantCulture)
          Dim Key As String = LCase(WordsWithSingleSpaceDelimiter(City.Name))
		...
		Private Function LoadCountries() As Collections.Generic.List(Of Country)
          ...
          Country.CountryId = CInt(Fields(0))
          Country.Name = StringValue(Fields(1))
		...
		Private Function LoadRegions() As Collections.Generic.Dictionary(Of Integer, Region)
          ...
          Region.RegionId = CInt(Fields(0))
          Region.Name = StringValue(Fields(2))
    ...
    End Function
      ...
      Return Countries(City.CountryID - 1).Name
		End Function
		Function RegionName(ByVal City As City) As String
      Return Regions(City.RegionID).Name
		End Function
	End Module
End Namespace