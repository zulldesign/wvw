...
Namespace WebApplication
    ...
    Public Sub CompressGZip(ByVal FileNames() As String, ByVal ZipFileName As String, Optional ByVal PathName As String = Nothing)
      ...
      For Each FileName As String In FileNames
        ...
        Catch ex As Exception
          Extension.Log("Zip", 1000, PathName, FileName, ex.Message)
        End Try
      Next
      OuputGzip.Close()
      Output.Close()
    End Sub
      ...
      If Not String.IsNullOrEmpty(Path) AndAlso FullFileName.StartsWith(Path, StringComparison.InvariantCultureIgnoreCase) Then
      ...
      ReDim fileContents(CInt(fileLength - 1))
      stream.Read(fileContents, 0, CInt(fileLength))
