...
Namespace WebApplication.Plugin		'Standard namespace obbligatory for all plugins
    ...
    Private Shared SharedConfiguration As AddHtmlCodeConfiguration = CType(Plugin.LoadSharedConfiguration(), AddHtmlCodeConfiguration)
    ...
    Private Shared Sub Plugin_MasterPagePreRender(ByVal MasterPage As Components.MasterPageEnhanced) Handles Plugin.MasterPagePreRender
      ...
      For N As Integer = 0 To 1
        If CBool(N) Then
          Configuration = CType(Plugin.LoadConfiguration(), AddHtmlCodeConfiguration)
        Else
