...
Namespace WebApplication.Plugin		'Standard namespace obbligatory for all plugins
      ...
      If Plugin Is Nothing Then Plugin = New PluginManager.Plugin(AddressOf Description, , , , PluginManager.Plugin.Characteristics.StandardPlugin, GetType(DonationConfiguration), GetType(DonationSharedConfiguration))
        ...
        Case LanguageManager.Language.Italian
          Return "Campagna donazioni"
			...
			End Select
		End Function
    Private Shared SharedConfiguration As DonationSharedConfiguration = CType(Plugin.LoadSharedConfiguration(), DonationSharedConfiguration)
    ...
    Private Shared Sub Plugin_MasterPagePreRender(ByVal MasterPage As Components.MasterPageEnhanced) Handles Plugin.MasterPagePreRender
      ...
      If SharedConfiguration.Enabled Then
        For Each Config As DonationConfiguration In SharedConfiguration.Configurations
          If Config.Campaign.Language = MasterPage.Setting.Language OrElse Config.Campaign.Language = LanguageManager.Language.NotDefinite Then
      ...
      If Configuration Is Nothing Then
        Configuration = CType(Plugin.LoadConfiguration(), DonationConfiguration)
      End If
          ...
          If (MetaTag Is Nothing OrElse MetaTag.Content <> "noindex") AndAlso MasterPage.ShowRightBar = True Then 'Only page indexabled 
            ...
            With Configuration.Campaign
              ...
              If Now > .StartDay AndAlso Now < (.StartDay.AddDays(.Days)) Then
                ...
                Dim Hours As Integer = CInt(DateDiff(DateInterval.Hour, .StartDay, Now))
                If Hours > TotHours Then Hours = TotHours
                Dim Round As Integer = 3
                Dim NowMoney As Integer = CInt(CInt((Target / TotHours * Hours) / Round) * Round)
                Dim NowPercentage As Integer = CInt(Hours / TotHours * 100)
                ...
                Td1.Style.Add(HtmlTextWriterStyle.WhiteSpace, "nowrap")
                ...
                Td2.Style.Add(HtmlTextWriterStyle.VerticalAlign, "right")
                Td2.Style.Add(HtmlTextWriterStyle.WhiteSpace, "nowrap")
                Td2.Style.Add(HtmlTextWriterStyle.Height, "20")
                Td2.Style.Add(HtmlTextWriterStyle.Width, (100 - NowPercentage) & "%")
                Td2.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#00FF00")
    ...
    End Sub
		...
		Class Campaign
      Public Language As LanguageManager.Language = GetCurrentLanguage()
      ...
      Private Function GetCurrentLanguage() As LanguageManager.Language
        Try
          Dim Setting As SubSite = CurrentSetting()
          Return CurrentSetting.Language
        Catch ex As Exception
          Return LanguageManager.Language.NotDefinite
        End Try
      End Function
    End Class
