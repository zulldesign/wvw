...
Namespace WebApplication.Plugin		'Standard namespace obbligatory for all plugins
    ...
    Private Shared SharedConfiguration As AdsenseSharedConfiguration = CType(Plugin.LoadSharedConfiguration(), AdsenseSharedConfiguration)
                ...
                Select Case Configuration.AdvertisingRotation
                  ...
                  Case Else
                    ...
                    For Each Author As User In MasterPage.Authors
                      GoogleClient = CStr(Author.Attribute("GoogleClient"))
                      If IsValidGoogleClient(GoogleClient) Then
                        GoogleClients.Add(GoogleClient)
                      End If
                    Next
                    If CBool(GoogleClients.Count) Then
    ...
    End Function
		...
		Shared Function LoadConfiguration() As AdsenseConfiguration
			...
			Else
        Dim Local As AdsenseLocalConfiguration = CType(Plugin.LoadConfiguration(), AdsenseLocalConfiguration)
    ...
    End Function
        ...
        Code = ReadAll(MapPath(CodesSubDirectory & "\adsense.html"))
			End If
      ...
      AdSenseCode = ReplaceBin(AdSenseCode, "#WIDTH", CStr(Width))
      AdSenseCode = ReplaceBin(AdSenseCode, "#HEIGHT", CStr(Height))
