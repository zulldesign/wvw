...
Namespace WebApplication.Plugin    'Standard namespace obbligatory for all plugins
  ...
  Public Class AddCustomButtons
    ...
    Private Shared SharedConfiguration As AddCustomButtonsConfiguration = CType(Plugin.LoadSharedConfiguration(), AddCustomButtonsConfiguration)
    ...
    Private Shared Sub Plugin_MasterPagePreRender(ByVal MasterPage As Components.MasterPageEnhanced) Handles Plugin.MasterPagePreRender
      ...
      For Conf As Integer = 0 To 1
        ...
        Else
          Configuration = CType(Plugin.LoadConfiguration(), AddCustomButtonsConfiguration)
        End If
        If CBool(Configuration.Buttons.Length) Then
    ...
    Class Button
      ...
      Public Target As Components.MasterPageEnhanced.TargetForButton = Components.MasterPageEnhanced.TargetForButton.Self
