...
<table width="100%" height="32" border="0" cellpadding="4" cellspacing="0" background="../gfx/underline1.gif">
  <tr>
    <td class="subhead1">&nbsp;Administration - RBlog <% 
Fnctn = Request.QueryString
If len(Request.Form("deed")) > len(Fnctn) Then
	Fnctn = Request.Form("deed")
End If
...
<table width="760" border="0" cellspacing="0" cellpadding="3">
  <tr>
	...
	If Len(Request.QueryString) < 3 Or Request.QueryString = "edit" Or Request.QueryString = "delete" Then
		%><tr><td><%
		...
		If Not(RS.EOF) Then
			...
			<tr class=bodytext1 bgcolor="#99CCFF">
					<td><b>Title</b></td>
